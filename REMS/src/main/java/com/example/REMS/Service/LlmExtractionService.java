 ...
 *  - extractCustomer() : 고객(리드) 초안 (요약/전화/금액/입주희망일/위치/대출/미팅날짜/메모)
 */
@Service
public class LlmExtractionService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            [출력 스키마]
            {
              ...
              "tenant": { "phone": null, "buildingName": null, "unitName": null, "deposit": 0, "rent": 0, "manage": 0,
    ...
    private static final String CUSTOMER_PROMPT = """
            ...
            [출력 스키마]
            {
              "summary": null, "phone": null, "amount": null, "moveInDate": null,
